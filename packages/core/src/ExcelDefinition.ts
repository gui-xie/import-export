import type { ErrorLocalizationOptions, ErrorLocale, ErrorMessageContext, ErrorMessages, ErrorMessageTemplate, ImportExportErrorCode } from './errors';
...
interface ExcelDefinition extends ErrorLocalizationOptions {
  ...
  /** Error message language. Defaults to English. Use `zh` or `zh-CN` for Chinese. */
  locale?: ErrorLocale;
  /** Custom error messages keyed by stable error code. Receives params when using function messages. */
...
interface DynamicExcelImportOptions extends ErrorLocalizationOptions {
